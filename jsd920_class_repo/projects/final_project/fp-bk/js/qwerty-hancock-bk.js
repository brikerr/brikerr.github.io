...
(function () {
    ...
    var init = function (us) {
        ...
        settings = {
            ...
            whiteKeyColour: user_settings.whiteKeyColour || '#000',
            blackKeyColour: user_settings.blackKeyColour || '',
            activeColour:   user_settings.activeColour || '',
            borderColour:   user_settings.borderColour || '',
